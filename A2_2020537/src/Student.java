            ...
            if((Assignment.getHashMap().containsKey(i) && Assignment.getHashMap().get(i).isClosed()==false) || (Quiz.getHashMap().containsKey(i) && Quiz.getHashMap().get(i).isClosed()==false)) {
                if (submissions.isEmpty() == true || (submissions.isEmpty() == false && !submissions.containsKey(i))) {
                    if (Assignment.getHashMap().containsKey(i)) {
                        System.out.println("ID " + Assignment.getHashMap().get(i).getAssessmentID() + " Assignment: " + Assignment.getHashMap().get(i).getProblemStatement() + " Max Marks: " + Assignment.getHashMap().get(i).getMarks());
                        check.add(i);
                    } else if (Quiz.getHashMap().containsKey(i)) {
                        System.out.println("ID: " + Quiz.getHashMap().get(i).getAssessmentID() + " Question: " + Quiz.getHashMap().get(i).getProblemStatement());
                        check.add(i);
                    }
                }
            }
