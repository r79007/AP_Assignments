...
public class Instructor implements Discussions{
    ...
    private static HashMap<String, ArrayList<Assessment>> instructorToAssignmentMap=new HashMap<>();
    private static HashMap<String, ArrayList<Assessment>> instructorToQuizMap=new HashMap<>();
    private String id;
    ...
    public static ArrayList<Assessment> getAssignments(String iden){
        return instructorToAssignmentMap.get(iden);
    }

    public static void setInstructorToQuizMap(String iden,Assessment assn){
    ...
    public static ArrayList<Assessment> getQuizzes(String iden){
