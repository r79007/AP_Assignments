...
public class Main {
    ...
    public static void viewAssignments(String iden){
    ...
    public static void viewOpenAssignments(String iden){
        ArrayList<Assignment> arr=Instructor.getAssignments(iden);
        if(arr!=null && arr.size()!=0) {
            for (Assignment i : arr) {
                if(i.isClosed()==false) {
    ...
    public static void viewQuizzes(String iden){
        ArrayList<Quiz> arr=Instructor.getQuizzes(iden);
        if(arr!=null && arr.size()!=0) {
            for (Quiz i : arr) {
                System.out.println("ID: "+i.getAssessmentID()+" Assignment: "+i.getProblemStatement());
                System.out.println("----------------");
            }
        }
    }
    public static void viewOpenQuizzes(String iden){
        ArrayList<Quiz> arr=Instructor.getQuizzes(iden);
        if(arr!=null && arr.size()!=0) {
            for (Quiz i : arr) {
                if(i.isClosed()==false) {
    ...
    public static void viewOpenAssessments(){
        ArrayList<String> instructors=Instructor.getInstructorsList();
        for(String i:instructors){
            viewOpenAssignments(i);
            System.out.println("----------------");
            viewOpenQuizzes(i);
            System.out.println("----------------");
        }
                ...
                while (ip != 9) {
                    ...
                    if (ip == 1) {
                        ...
                        if (option == 1) {
                            ...
                            Assignment.setAssignmentHashMap(assignmentIDs,assn);
                            assignmentIDs++;
                            ...
                            Quiz.setQuizHashMap(assignmentIDs,qz);
                            assignmentIDs++;
                        ...
                        Grading.getUngradedSubmissions(assmID);
                        ...
                        System.out.println("-------------------------------");
                        System.out.println("Max Marks: "+Assignment.getAssignmentHashMap().get(assmID).getMarks());
                        ...
                        g.setAssn(Assignment.getAssignmentHashMap().get(assmID));
                        ...
                        int asId=sc.nextInt();
                        if(Assignment.getAssignmentHashMap().containsKey(asId)){
                            Assignment.getAssignmentHashMap().get(asId).setClosed(true);
                        }else if(Quiz.getQuizHashMap().containsKey(asId)){
                            Quiz.getQuizHashMap().get(asId).setClosed(true);
                        }else{
                ...
                while (ip2 != 7) {
                    if(ip2==1) {
                        ...
                        if(!(check==null || check.size()==0)) {
                            ...
                            if (Assignment.getAssignmentHashMap().containsKey(assnIden)) {
                            ...
                            } else if (Quiz.getQuizHashMap().containsKey(assnIden)) {
                                System.out.print(Quiz.getQuizHashMap().get(assnIden).getProblemStatement() + ": ");
                                sc.nextLine();
                        ...
                        if(!Student.getStudentClassList().get(student).getSubmissionsMap().isEmpty()) {
                            for (Integer i : Student.getStudentClassList().get(student).getSubmissionsMap().keySet()) {
                                if (!gradedSubmissions.contains(i) && Assignment.getAssignmentHashMap().containsKey(i)) {
