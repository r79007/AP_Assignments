...
public class Main {
    ...
    public static ArrayList<Assignment> viewAssignments(String iden){
    ...
    public static ArrayList<Quiz> viewQuizzes(String iden){
        ArrayList<Quiz> arr=Instructor.getQuizzes(iden);
        ArrayList<Quiz> check=new ArrayList<>();
        if(arr!=null && arr.size()!=0) {
            for (Quiz i : arr) {
    ...
    public static ArrayList<Quiz> viewOpenQuizzes(String iden){
        ArrayList<Quiz> arr=Instructor.getQuizzes(iden);
        ArrayList<Quiz> check=new ArrayList<>();
        if(arr!=null && arr.size()!=0) {
            for (Quiz i : arr) {
    ...
    public static Boolean viewAssessments(){
        ...
        for(String i:instructors){
            ArrayList<Assignment> arrA=viewAssignments(i);
